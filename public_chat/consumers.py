...
def get_num_connected_users(room):
	"""Retourne le nombre réel d'utilisateurs connectés à la salle."""
...
class LazyRoomChatMessageEncoder(Serializer):
	"""
	Sérialiseur pour les messages du chat public.
	Défini AVANT get_room_chat_messages pour éviter NameError.
	ClientError est importé depuis chat.exceptions -- pas de redéfinition ici.
	"""
