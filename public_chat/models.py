...
class PublicChatRoom(models.Model):
	...
	users 				= models.ManyToManyField(settings.AUTH_USER_MODEL, blank=True, related_name="Chat_room", help_text="users who are connected to chat room.")
...
class PublicRoomChatMessage(models.Model):
    ...
    """
    user                = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="Chat_message")
